...
app.post('/connexion/repair', async (req, res) => {
  try {
    ...
    if (existing) {
      ...
      return res.json({ success: true, action: 'déjà_actif', company_name: company.company_name, company_id: company.id });
    }
    ...
    return res.json({ success: true, action: 'créé', company_name: company.company_name, company_id: company.id });
